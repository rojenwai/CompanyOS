...
[engineering agents](agents.md), coordinated by the [orchestration kernel](../orchestration/README.md).
...
| [ai/](../ai/) | model integration | AI engineering standards |
| [post-launch/](../post-launch/) | operability, maintenance | monitoring, on-call handoff |
| [orchestration/](../orchestration/) | task routing, review, approval | Coordinator + reviewers |
