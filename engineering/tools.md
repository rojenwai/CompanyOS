...
| Dependency / security scanners | Enforce [security standards](security-standards.md) | Feeds [Security Patch Agent](../agents/post-launch/security-patch-agent.md) |
...
| API / schema tooling | OpenAPI, contract tests | Owned by [API Architect](../agents/engineering/api-architect.md) |
