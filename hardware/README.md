...
Hardware co-designs with [engineering](../engineering/README.md) (firmware and software interfaces), embeds [AI](../ai/README.md) on-device where needed, is validated like any product through the [SDLC](../workflows/sdlc.md), and is maintained in the field via [post-launch](../post-launch/README.md).
