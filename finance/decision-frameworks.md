...
- **Spend vs. conserve** - Spend when the expected return beats the cost of the runway consumed.
- **Raise vs. extend runway** - Model both; choose based on terms, dilution, and the strength of the working model.
- **Build vs. buy (financial view)** - Compare total cost of ownership, not sticker price.
