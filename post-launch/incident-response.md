...
6. **Postmortem** — root cause, timeline, action items → [lessons-learned](../memory/lessons-learned.md).
...
Incidents are coordinated through the [orchestration Coordinator](../orchestration/coordinator.md);
irreversible remediation requires [approval](../orchestration/approval-engine.md).
