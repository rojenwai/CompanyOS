...
5. **Root cause & prevent:** add/repair monitoring so silent failures cannot recur ([Database Maintenance Agent](../../agents/post-launch/database-maintenance-agent.md)).
