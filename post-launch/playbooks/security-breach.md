...
4. **Eradicate:** patch the vulnerability ([Security Patch Agent](../../agents/post-launch/security-patch-agent.md)); close the entry point.
...
8. **Postmortem** → [lessons-learned](../../memory/lessons-learned.md).

**Success criteria:** breach contained, entry closed, obligations met, evidence preserved.
**Escalate immediately:** breaches always require human leadership and legal ([approval](../../orchestration/approval-engine.md)); a Security Reviewer block cannot be auto-overridden.
