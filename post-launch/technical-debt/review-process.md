...
A regular debt review (e.g. per sprint) run by the [Maintenance Manager](../../agents/post-launch/maintenance-manager.md):

1. Ingest new items from the [Technical Debt Agent](../../agents/post-launch/technical-debt-agent.md) and manual reports.
2. Re-[prioritize](prioritization.md) the backlog.
3. Confirm this cycle's repayment selection fits the reserved capacity.
4. Route repayment to the [Refactoring Agent](../../agents/engineering/refactoring-agent.md) or owning engineer.
