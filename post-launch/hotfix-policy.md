...
- **Still reviewed** — an expedited [review](review-process.md) and [security check](../orchestration/security-reviewer.md) still apply; quality gates are compressed, not skipped.
- **Tested** — includes a test reproducing the issue.
- **Approved** — production change requires [approval](../orchestration/approval-engine.md).
