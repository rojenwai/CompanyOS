...
2. Use GitHub's **[private vulnerability reporting](https://github.com/rojenwai/AI-Company-Repo/security/advisories/new)**
...
- ❌ Out of scope: vulnerabilities in *your own* company built with this framework — use the framework's
  own [security standards](../engineering/security-standards.md) and
  [incident response](../post-launch/incident-response.md) for those.

## For companies built on Company OS

Your product's security is governed by the framework itself:
[engineering/security-standards.md](../engineering/security-standards.md),
[ai/ai-security.md](../ai/ai-security.md), the [Security Reviewer](../orchestration/security-reviewer.md),
and the [security-breach playbook](../post-launch/playbooks/security-breach.md).
