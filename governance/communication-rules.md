...
Structured reports are reviewable, comparable, and storable in [memory](../memory/). They force the
author to separate evidence from opinion and to state confidence explicitly, which is essential for
[hallucination prevention](../ai/README.md) and for downstream agents that consume the output.
