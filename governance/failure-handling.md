...
This is a governance rule that every [agent](../agents/agent-template.md) inherits through its
...
This rule is the backbone of [hallucination prevention](../ai/README.md) and of the company
