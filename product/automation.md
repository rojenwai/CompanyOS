...
|---|---|---|---|---|
| Feedback intake | New ticket/review/request | Classify and route to backlog | [Customer Journey Agent](../agents/product/customer-journey-agent.md) | Review before commit |
...
without PM review and [approval](../orchestration/approval-engine.md).
