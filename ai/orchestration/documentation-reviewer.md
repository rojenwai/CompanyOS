...
## 3. Inputs
The deliverable and its documentation; the [documentation requirements](../../handbook/departments/engineering/documentation-requirements.md).

## 4. Outputs
A verdict with specific documentation gaps.

## 5. Tools
Doc linters; link checkers; the [documentation standards](../../handbook/departments/engineering/documentation-requirements.md).
...
Part of the pre-release [quality gates](../../handbook/governance/quality-gates.md).
