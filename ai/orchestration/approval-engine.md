...
The approval engine applies [governance](../../handbook/governance/) to work that has passed review, deciding
whether it can proceed autonomously or requires human sign-off.

## What it enforces

- The [quality gates](../../handbook/governance/quality-gates.md) for the current phase.
- The reversible/irreversible test from the [decision framework](../../handbook/governance/decision-framework.md).
