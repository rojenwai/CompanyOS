...
Structured reports from every division; company [strategy](../../handbook/company/vision.md); [memory](../memory/)
...
2. Frame the objective and success metrics (via the [decision framework](../../handbook/governance/decision-framework.md)).
...
6. Approve milestones at [quality gates](../../handbook/governance/quality-gates.md).
...
missing, applies [failure handling](../../handbook/governance/failure-handling.md).

## 9. Quality standards

Decisions must answer the full [decision framework](../../handbook/governance/decision-framework.md) and be
