...
guessing ([failure handling](../../handbook/governance/failure-handling.md)).

## 9. Quality standards

Plans must be minimal (no unnecessary work — [YAGNI](../../handbook/departments/engineering/principles.md)), have explicit
