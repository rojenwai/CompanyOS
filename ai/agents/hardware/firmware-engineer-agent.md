...
- Works with Electrical and [engineering](../../../handbook/departments/engineering/README.md)
- Coordinates security with [security](../../../handbook/departments/security/README.md)
