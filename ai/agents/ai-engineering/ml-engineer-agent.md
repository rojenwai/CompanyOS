...
- Labeled datasets from [data](../../../handbook/departments/data/README.md)
- Task metrics
- Serving constraints
...
- Works with [Data Engineer](../../../handbook/departments/data/README.md)
- Deploys via [devops](../../../handbook/departments/devops/README.md)

## 8. Escalation rules

- Escalate when data quality caps model quality
- Flag drift to [post-launch](../../../handbook/departments/post-launch/README.md)
