...
## 3. Inputs
Dependency manifests; advisories; the [dependency rules](../../../handbook/departments/engineering/standards.md#dependency-rules).
...
Coordinates with the Security Patch Agent and [legal](../../../handbook/company/roles.md) (licenses).

## 8. Escalation rules
Breaking updates require review/approval; vulnerable-with-no-fix triggers the [dependency-vulnerability playbook](../../../handbook/departments/post-launch/playbooks/dependency-vulnerability.md).
