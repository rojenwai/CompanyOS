...
**Division:** Post-Launch / Maintenance · **Reports to:** [Chief Security Officer](../../../handbook/company/roles.md)
...
## 3. Inputs
Security advisories; scanner findings; the [security standards](../../../handbook/departments/engineering/security-standards.md).

## 4. Outputs
Patch PRs / mitigations; risk assessments; escalations for active exploitation.

## 5. Tools
Security scanners; CI; the [security review template](../../../handbook/templates/documents/security-review.md).
...
## 8. Escalation rules
Active exploitation → [security-breach playbook](../../../handbook/departments/post-launch/playbooks/security-breach.md) and human leadership; a Security Reviewer block is never auto-overridden.
