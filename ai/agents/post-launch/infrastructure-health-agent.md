...
## 3. Inputs
Infrastructure metrics; [cost dashboards](../../../handbook/departments/post-launch/dashboards.md); capacity plans.
...
Coordinates with the Cloud Engineer; escalates cost spikes to the [high-cloud-cost playbook](../../../handbook/departments/post-launch/playbooks/high-cloud-cost.md).

## 8. Escalation rules
Infra outages → [critical-outage playbook](../../../handbook/departments/post-launch/playbooks/critical-outage.md); irreversible infra changes need [approval](../../orchestration/approval-engine.md).
