...
People & HR builds and sustains the team that builds everything else. It owns recruiting, onboarding, performance and growth, compensation, and culture - for both human employees and the way [AI agents](../agents/README.md) and humans work together. Hiring is the founder's highest-leverage activity; this department makes it repeatable. It reports to the [COO](../company/roles.md).
...
People & HR staffs every department per the [org structure](../company/structure.md), plans headcount with [finance](../finance/README.md), and defines onboarding paths that get new hires and agents productive fast. Culture and role expectations trace to the [company principles](../company/principles.md).
