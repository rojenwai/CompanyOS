...
- Feeds [Market Research Agent](market-research-agent.md) and [product discovery](../../product/discovery.md)
- Challenges assumptions from [strategy](../../strategy/README.md)
- Cites all sources
