...
- Serves [engineering](../../engineering/workflows.md)
- Integrates [security](../../security/README.md) scans

## 8. Escalation rules

- Escalate a red pipeline on main ([failing-CI playbook](../../engineering/playbooks.md))
