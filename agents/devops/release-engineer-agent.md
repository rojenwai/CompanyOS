...
- Executes [release management](../../post-launch/release-management.md)
- Coordinates with [product](../../product/README.md) on timing

## 8. Escalation rules

- Trigger [rollback](../../post-launch/rollback.md) on failed post-deploy checks
...
Reviewed by the DevOps Lead; risky releases reviewed by [post-launch](../../post-launch/README.md).
