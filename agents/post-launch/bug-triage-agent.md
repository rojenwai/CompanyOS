...
## 2. Responsibilities
Reproduce, classify (severity/priority/type), deduplicate, and route bugs per [bug-management](../../post-launch/bug-management.md).

## 3. Inputs
Bug reports from [support](../../post-launch/support.md), crash reporting, and monitoring.
...
Feeds engineering and the Maintenance Manager; recurring clusters → [product feedback](../../post-launch/customer-feedback.md).

## 8. Escalation rules
Critical/customer-impacting bugs are escalated to [incident response](../../post-launch/incident-response.md).
