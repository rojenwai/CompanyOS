...
## 3. Inputs
DB metrics; backup logs; the [database standards](../../engineering/database-standards.md).
...
Works with the [Database Engineer](../engineering/database-engineer.md); coordinates retention with [legal/privacy](../../company/roles.md).

## 8. Escalation rules
Failed backup → [failed-backup playbook](../../post-launch/playbooks/failed-backup.md); corruption/data-loss risk → [database-failure playbook](../../post-launch/playbooks/database-failure.md) + [approval](../../orchestration/approval-engine.md).
