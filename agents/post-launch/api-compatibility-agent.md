...
## 2. Responsibilities
Diff API contracts across changes; detect breaking changes; enforce versioning and [deprecation](../../post-launch/deprecation-policy.md).
...
## 5. Tools
Contract diffing; consumer analytics; the [API standards](../../engineering/api-standards.md).
...
Works with the [API Architect](../engineering/api-architect.md); coordinates removals via the [deprecation policy](../../post-launch/deprecation-policy.md).
