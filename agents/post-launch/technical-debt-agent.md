...
regressions, and documentation drift; file tracked [debt items](../../post-launch/technical-debt/tracking.md).

## 3. Inputs
The codebase; static analysis; dependency data; [performance](performance-monitoring-agent.md) findings.

## 4. Outputs
Tracked debt items (with type, impact, estimate); debt-trend data for [metrics](../../post-launch/technical-debt/metrics.md).

## 5. Tools
Static analysis; duplication/dead-code detectors; dependency scanners.

## 6. Workflows
1. Scan on schedule and on PRs. 2. Classify and estimate each finding. 3. File to [tracking](../../post-launch/technical-debt/tracking.md). 4. Surface trends.

## 7. Collaboration rules
Feeds the [debt review](../../post-launch/technical-debt/review-process.md); repayment routed to the [Refactoring Agent](../engineering/refactoring-agent.md).
...
Findings reviewed at the periodic [debt review](../../post-launch/technical-debt/review-process.md).
