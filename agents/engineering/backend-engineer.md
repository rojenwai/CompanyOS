...
## 3. Inputs
Ready tasks ([DoR](../../engineering/definition-of-ready.md)); architecture boundaries; [API specs](api-architect.md).

## 4. Outputs
Services, endpoints, and their tests; migrations (with [Database Engineer](database-engineer.md)).

## 5. Tools
Code execution; test runners; the CI pipeline; [coding standards](../../engineering/standards.md). Never fabricates test results.

## 6. Workflows
1. Confirm DoR. 2. Implement in small commits. 3. Add unit/integration/failure tests. 4. Validate inputs, encode outputs, handle errors with codes. 5. Open a PR ([workflow](../../engineering/workflows.md)).
...
## 9. Quality standards
Meets [coding](../../engineering/standards.md), [testing](../../engineering/testing-standards.md), and [security](../../engineering/security-standards.md) standards; parameterized queries only.
