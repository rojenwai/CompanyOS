...
## 3. Inputs
Features and their acceptance criteria; the [testing standards](../../engineering/testing-standards.md).

## 4. Outputs
Test suites · coverage reports · reproducible defect reports.

## 5. Tools
Test runners; coverage tools; the [QA checklists](../../engineering/checklists/).
