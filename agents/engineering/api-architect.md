...
## 3. Inputs
Requirements; consumer needs; the [API standards](../../engineering/api-standards.md).
...
## 9. Quality standards
Every endpoint defines the full [API standards](../../engineering/api-standards.md) checklist; documented with OpenAPI.
