...
## 2. Responsibilities
Refactor code flagged by the [technical debt policy](../../engineering/technical-debt-policy.md): duplication, dead code, complexity, unclear structure.

## 3. Inputs
Debt items from the [Technical Debt Agent](../post-launch/technical-debt-agent.md); the [refactoring policy](../../engineering/refactoring-policy.md).
...
Coordinates with implementers to avoid conflicts; records structural changes as [ADRs](../../templates/documents/adr.md).
...
Reviewed via the standard [review process](../../engineering/review-process.md); suite must stay green.
