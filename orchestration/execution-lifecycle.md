...
1. Compare against acceptance criteria and [standards](../standards/) — the objective rule wins.
...
- **Post-execution failure**: trigger [rollback](../post-launch/rollback.md) and an [incident report](../templates/documents/incident-report.md).
