...
Documentation makes the company's knowledge - for customers and for the team - accurate, findable, and current. It owns product docs, API references, internal knowledge, and the information architecture that ties them together. It partners with the [Documentation Maintenance Agent](../agents/post-launch/documentation-maintenance-agent.md) (which fights drift) and reports to the [COO](../company/roles.md).
...
Documentation turns [engineering](../engineering/documentation-requirements.md) and [product](../product/README.md) work into user-facing docs, maintains the internal knowledge that [operations](../operations/README.md) relies on, and keeps the [documentation memory](../memory/documentation-memory.md) index accurate and owned.
