...
- All automated actions by the [Execution Engine](../../../ai/orchestration/execution-engine.md) and agents are logged.
- Observability data is retained per [retention policy](../../../ai/memory/retention-and-versioning.md) and is the
