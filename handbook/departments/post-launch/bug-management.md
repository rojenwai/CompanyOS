...
[Bug Triage Agent](../../../ai/agents/post-launch/bug-triage-agent.md).
...
Security bugs route to the [Security Patch Agent](../../../ai/agents/post-launch/security-patch-agent.md);
regressions to the [Regression Agent](../../../ai/agents/post-launch/regression-agent.md).

## Rules

- Every fix ships with a test that reproduces the bug (prevents [regression](../../../ai/agents/post-launch/regression-agent.md)).
