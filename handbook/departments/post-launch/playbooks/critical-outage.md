...
7. **Postmortem** → [lessons-learned](../../../../ai/memory/lessons-learned.md).

**Success criteria:** service restored within SEV target; customers informed throughout.
**Escalate if:** not mitigated within the SEV1 target → [CEO Agent](../../../../ai/orchestration/ceo-agent.md) + human leadership.
