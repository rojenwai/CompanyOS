...
3. **Execute** via the [Execution Engine](../../../../ai/orchestration/execution-engine.md) (blue-green switch, previous artifact, or revert).
...
**Escalate if:** rollback fails or migrations are irreversible → SEV1 [outage](critical-outage.md) + [approval](../../../../ai/orchestration/approval-engine.md) for recovery.
