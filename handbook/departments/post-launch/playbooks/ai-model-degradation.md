...
3. **Mitigate:** roll back to the last known-good [prompt/model version](../../../../ai/memory/prompt-memory.md); route to a fallback model if needed.
4. **Diagnose** against the [evaluation framework](../../ai-engineering/README.md); reproduce on the eval set.
5. **Fix:** update prompt/model; re-run [AI tests](../../ai-engineering/README.md) (prompt regression, adversarial) before redeploy.
