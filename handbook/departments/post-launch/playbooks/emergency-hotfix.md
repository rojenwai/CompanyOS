...
4. **Expedited review** — [Reviewer](../../../../ai/orchestration/reviewer.md) + [Security Reviewer](../../../../ai/orchestration/security-reviewer.md) if relevant; gates compressed, not skipped.
5. **Approve & deploy** — production change requires [approval](../../../../ai/orchestration/approval-engine.md); deploy phased; verify.
