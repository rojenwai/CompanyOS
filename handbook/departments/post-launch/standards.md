...
- **Every incident has a postmortem** — root cause and action items recorded to [lessons-learned](../../../ai/memory/lessons-learned.md).
- **Every fix has a test** — bugs ship with a reproducing test to prevent [regression](../../../ai/agents/post-launch/regression-agent.md).
...
- **Backups are tested** — restores are verified, not assumed ([database maintenance](../../../ai/agents/post-launch/database-maintenance-agent.md)).
