...
2. Trigger rollback via the [Execution Engine](../../../ai/orchestration/execution-engine.md) (automated where possible).
...
actions ([execution lifecycle](../../../ai/orchestration/execution-lifecycle.md)).
