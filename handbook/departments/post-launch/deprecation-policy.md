...
1. **Decide** — via [product evolution](product-evolution.md); record in [decision memory](../../../ai/memory/decision-memory.md).
...
- The [API Compatibility Agent](../../../ai/agents/post-launch/api-compatibility-agent.md) monitors for accidental breaking changes.
