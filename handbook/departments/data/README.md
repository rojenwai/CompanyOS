...
Data turns raw events into trustworthy datasets, metrics, and insight - the fuel for product decisions, [AI](../ai-engineering/README.md) grounding, and company [dashboards](../post-launch/dashboards.md). It owns pipelines, data quality, modeling, analytics, and governance. It reports to the [CTO](../../company/roles.md).
...
Data provides clean datasets and features to [ai](../ai-engineering/README.md), the metrics behind every department's [dashboards](../post-launch/dashboards.md), and the analytics [product](../product/analytics.md) uses to decide. It works with [security](../security/README.md) and [legal](../legal/README.md) on privacy and governance.
