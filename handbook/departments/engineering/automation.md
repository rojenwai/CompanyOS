...
| Dependency scan | PR / schedule | Flag vulnerable/outdated deps | [Dependency Update Agent](../../../ai/agents/post-launch/dependency-update-agent.md) | Review PRs |
| Deploy | Merge to release branch | Build → staging → prod (phased) | [Execution Engine](../../../ai/orchestration/execution-engine.md) | **Yes** for production |
