...
[Database Engineer](../../../ai/agents/engineering/database-engineer.md).
...
- Define a data-retention policy per table (aligns with [privacy](../../../ai/memory/retention-and-versioning.md)).
- Back up and test restores; ongoing health is owned by the [Database Maintenance Agent](../../../ai/agents/post-launch/database-maintenance-agent.md).
