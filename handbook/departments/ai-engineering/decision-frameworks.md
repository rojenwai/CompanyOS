...
- **Autonomy vs. human-in-the-loop** - Autonomous only when objective is clear, safe, and confident; otherwise HITL ([approval engine](../../../ai/orchestration/approval-engine.md)).
