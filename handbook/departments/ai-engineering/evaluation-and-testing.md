...
- **Memory consistency** — context is assembled correctly ([memory](../../../ai/memory/README.md)).
...
and feeds the [continuous improvement loop](../../../ai/orchestration/continuous-improvement-engine.md).
