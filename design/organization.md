...
| [AI](../ai/README.md) | Designing AI interactions (streaming, uncertainty, corrections) |
| [Post-launch](../post-launch/README.md) | Usability issues surfaced in support and analytics |

## Where design plugs into the kernel

Design work is decomposed and routed by the [coordinator](../orchestration/coordinator.md); design
